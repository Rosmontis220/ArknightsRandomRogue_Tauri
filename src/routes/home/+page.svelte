<script lang="ts">
	...
	// An empty ID is the normal first-run state, and "Dr.未填写" is not a greeting, so the
	// salutation is dropped for the bare one rather than filled with a placeholder.
	const line = $derived(
		name === ''
