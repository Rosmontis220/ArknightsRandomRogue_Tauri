 ...
 * per generator: a 老缠杯 entry carries `laochan_pool` and no `opening_rogue_name` at
 * all. A view that reads named properties therefore renders another mode's entries as
 * blank rows — which is exactly the bug this module exists to prevent.
 *
