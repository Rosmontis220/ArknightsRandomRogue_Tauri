 ...
 * (see `generators/drama.ts`), and `opening.test.ts` pins this one's output over a
 * fixed input matrix of names, dates, levels, rogue sets, flags and exclusion sets.
 */
...
/** The shared action list under this generator's own name. */
export { DRAMA_ACTIONS as OPENING_ACTIONS };
