...
export const ICON_PATHS = {
	...
	/** A stack of cards. 老缠杯 deals a fixed hand rather than banning or picking. */
	cards: [
		'M9.5 3.5H18a2 2 0 0 1 2 2v10',
		'M7.5 6.5h5a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-5a2 2 0 0 1-2-2v-10a2 2 0 0 1 2-2Z'
	],
