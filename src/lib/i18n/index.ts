...
const ZH_CN: Record<string, string> = {
	...
	/*
	 * 投钱问路: the daily three-coin toss from 岁的界园志异. The coin names and verses are
	 * game text and come from the data file, not from here; these are the labels around
	 * them. `fate`/`flower`/`risk` are the game's own three announcements for a finished
	 * toss, which is why they read as sentences rather than as state names.
	 */
	'home.fortune.title': '投钱问路',
	'home.fortune.subtitle': '今日运势',
	'home.fortune.hint': '默念问题后投钱，心诚则灵。',
	'home.fortune.toss': '投钱',
	'home.fortune.tossing': '投钱中…',
	'home.fortune.verdict.fate': '听天由命',
	'home.fortune.verdict.flower': '花钱带来繁荣',
	'home.fortune.verdict.risk': '厉钱带来凶险',
	...
	'about.featureFortune': '首页投钱问路：岁的界园志异的 103 枚通宝，每天三枚',
	'about.developer': '开发者',
...
const EN: Record<string, string> = {
	...
	// 投钱问路; see the note on the Chinese catalogue.
	'home.fortune.title': 'Tongbao Toss',
	'home.fortune.subtitle': "Today's fortune",
	'home.fortune.hint': 'Hold your question in mind, then toss.',
	'home.fortune.toss': 'Toss',
	...
	'about.featureFortune':
		'Tongbao Toss on the home page: all 103 coins of Sui’s Garden of Grotesqueries, three a day',
