...
const ZH_CN: Record<string, string> = {
	...
	'settings.box.help':
		'勾选表示「在 box 中」。存的是排除项，所以以后新增的干员默认在 box 里。「已拥有不可使用」的干员同样不参与抽取，按住 Ctrl 左键点击可切换；手机上是长按。',
...
const EN: Record<string, string> = {
	...
	'settings.box.help':
		'Ticked means “in box”. What is stored is the exclusions, so an operator added later is in the box by default. An operator marked “owned, unusable” is kept out of the draw too; hold Ctrl and left-click to switch it. On a touch screen, long-press instead.',
