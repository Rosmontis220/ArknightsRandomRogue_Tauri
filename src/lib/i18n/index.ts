...
const ZH_CN: Record<string, string> = {
	...
	// 老缠杯 fixes a theme like 仙术杯 does, and additionally caps the run to a drawn pool
	// of six-stars — so each edition needs the same three keys, plus the pool size.
	'generator.laochan1.name': '老缠杯 #1',
	'generator.laochan1.description': '限定肉鸽：探索者的银凇止境；整局只能用抽出的 10 位六星',
	'generator.laochan1.constraint':
		'肉鸽固定为探索者的银凇止境；老鲤与琳琅诗怀雅被抽到的概率是其他干员的 5 倍；本局只能使用抽出的 10 位六星干员。',
	'generator.laochan2.name': '老缠杯 #2',
	'generator.laochan2.description': '限定肉鸽：萨卡兹的无终奇语；整局只能用抽出的 12 位六星',
	'generator.laochan2.constraint':
		'肉鸽固定为萨卡兹的无终奇语；本局只能使用抽出的 12 位六星干员，没有其他限制。',
	'generator.laochan3.name': '老缠杯 #3',
	'generator.laochan3.description': '限定肉鸽：界园志异；整局只能用抽出的 10 位六星',
	'generator.laochan3.constraint':
		'肉鸽固定为界园志异；本局只能使用抽出的 10 位六星干员，没有其他限制。',
	...
	'result.summary.laochan.one': '{name} 这一局只能使用以下 {count} 位六星干员',
	'result.summary.laochan.other': '{name} 这一局只能使用以下 {count} 位六星干员',
	...
	// The easter egg is deliberately not announced. Narrowing the pool to 棘刺 and
	// 引星棘刺 *is* the joke, and printing "easter egg detected" tells the user they got
	// one — which is the one thing that would spoil it. They will notice from the pool.
	'result.export': '导出结果',
	...
	'settings.identity.help': 'ID 是种子的唯一来源。同一天、同一个 ID 的结果永远相同。',
	...
	'settings.box.help':
		'勾选表示「在 box 中」。存的是排除项，所以以后新增的干员默认在 box 里。「已拥有不可使用」的干员同样不参与抽取，按住 Ctrl 右键点击可切换。',
	...
	'settings.box.importMaaHelp':
		'选择 MAA 导出的干员 JSON：精英二满级的六星记为「在 box」，已拥有但未精英二的记为「已拥有不可使用」，其余略过。',
	'settings.box.importMaaOk':
		'导入完成：{usable} 位可用，{unusable} 位已拥有不可使用，{skipped} 位未拥有。',
	'settings.box.importMaaEmpty': '这个文件里没有找到六星干员。',
	'settings.box.importMaaBusy': '正在导入…',
	'settings.box.importMaaError.notJson': '这不是一个有效的 JSON 文件。',
	'settings.box.importMaaError.notArray': 'JSON 里没有找到干员数组。',
	'settings.box.importMaaError.readFailed': '读取文件失败：{reason}',
...
const EN: Record<string, string> = {
	...
	'generator.laochan1.description':
		"Locked to Expeditioner's Jǫklumarkar; ten six-stars, Lee and Swire the Elegant Wit weighted ×5",
	'generator.laochan1.constraint':
		"Theme fixed to Expeditioner's Jǫklumarkar. Lee and Swire the Elegant Wit are five times as likely to be drawn as anyone else, and the run may use only the ten six-stars drawn.",
	...
	'generator.laochan2.constraint':
		"Theme fixed to Sarkaz's Furnaceside Fables. The run may use only the twelve six-stars drawn; there are no other restrictions.",
	'generator.laochan3.name': 'LAO CHAN BEI #3',
	'generator.laochan3.description':
		"Locked to Sui's Garden of Grotesqueries; ten six-stars for the whole run",
	'generator.laochan3.constraint':
		"Theme fixed to Sui's Garden of Grotesqueries. The run may use only the ten six-stars drawn; there are no other restrictions.",
	...
	'result.summary.laochan.one': '{name} may use only the one six-star below this run',
	'result.summary.laochan.other': '{name} may use only the {count} six-stars below this run',
	...
	'settings.identity.help':
		'The ID is the seed’s only source. The same ID on the same day always gives the same result.',
	...
	'settings.box.help':
		'Ticked means “in box”. What is stored is the exclusions, so an operator added later is in the box by default. An operator marked “owned, unusable” is kept out of the draw too; hold Ctrl and right-click to switch it.',
	...
	'settings.box.importMaaHelp':
		'Pick an operator JSON exported by MAA: six-stars at elite 2 count as in your box, ones you own below elite 2 as “owned, unusable”, and the rest are skipped.',
	'settings.box.importMaaOk':
		'Imported: {usable} usable, {unusable} owned but unusable, {skipped} not owned.',
	'settings.box.importMaaEmpty': 'No six-star operators were found in that file.',
	'settings.box.importMaaBusy': 'Importing…',
	'settings.box.importMaaError.notJson': 'That is not a valid JSON file.',
	'settings.box.importMaaError.notArray': 'No operator list was found in the JSON.',
	'settings.box.importMaaError.readFailed': 'Could not read the file: {reason}',
